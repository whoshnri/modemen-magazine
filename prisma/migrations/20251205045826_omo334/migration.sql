...
INSERT INTO "new_Order" ("billingAddressId", "createdAt", "discountId", "id", "orderId", "paid", "reference", "shippingAddressId", "status", "subTotal", "total", "updatedAt", "userId") SELECT "billingAddressId", "createdAt", "discountId", "id", "orderId", "paid", "reference", "shippingAddressId", "status", "subTotal", "total", "updatedAt", "userId" FROM "Order";
DROP TABLE "Order";
