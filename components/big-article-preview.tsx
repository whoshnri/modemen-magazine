...
// Based on usage, it seems to be Article & { tags: ArticleTag[] }
// But let's try to be consistent with the app.
// For now, I'll define a compatible interface.
      ...
      <div className="relative z-10 h-full max-w-6xl mx-auto px-4 sm:px-6 flex flex-col justify-end pb-16 sm:pb-24">
        ...
        >
          ...
          {/* Title */}
            ...
            <h1 className="text-4xl sm:text-5xl md:text-7xl font-bold text-white mb-4 sm:mb-6 leading-tight  transition-colors duration-300">
              {article.title}
            </h1>
          ...
          <Link
            ...
            className="inline-flex items-center gap-3 text-gold-primary font-bold tracking-widest uppercase group/btn"
          >
            <span className="border-b-2 border-gold-primary pb-1 group-hover/btn:text-white group-hover/btn:border-white transition-colors">
              Read Full Story
            </span>
